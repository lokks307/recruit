...
* Frontend Engineer ( [신입](frontend/junior.md) / [경력채용](frontend/senior.md) )
* Flutter(Mobile) Engineer ( [신입](flutter/junior.md) / [경력채용](flutter/senior.md) )
...
* 우리는 별칭만 사용합니다. 영어 이름이 많지만, 독특한 한글 별명을 쓰는 사람도 있어요.
...
* 저는 모험가님을 지옥에서 살아남을 개발자로 만들지 않고, 😈 그 자체가 되길 바랍니다. 우리의 작은 두 손은 키보드와 마우스만으로도 모든 것을 만들어낼 수 있습니다.
* 이미 이 회사에는 😈😈😈😈😈😈😈😈 득실댑니다. 다들 실력이 보스급이예요.
